...
public class BrowseAllControllerIT {
	...
	public static Archive<?> createDeployment() {
		final WebArchive war = ArquillianUtils.createBasicPageTestDeployment("BrowseAllControllerIT", RecipeDAO.class, DaoException.class,
				BrowseAllController.class, IsSerializableMatcher.class, Recipe.class).addAsWebInfResource("META-INF/test-persistence.xml",
