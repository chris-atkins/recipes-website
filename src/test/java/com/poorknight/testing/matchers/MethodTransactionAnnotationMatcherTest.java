...
import static com.poorknight.testing.matchers.MethodTransactionAnnotationMatcher.hasCorrectTransactionLevelOnMethod;
...
public class MethodTransactionAnnotationMatcherTest {
	...
	public static class NonParameterizedTests {
		...
		public void failsIfMethodDoesNotExist() {
			boolean results = hasCorrectTransactionLevelOnMethod("nonExistantMethod", TransactionType.INSERT).matches(
					Object.class);
		...
		public void failsIfAllOverloadedMethodsDoNotHaveRequiredTransactionType() {
			boolean results = hasCorrectTransactionLevelOnMethod("insertMethod", TransactionType.INSERT).matches(
	...
	public static class ParameterizedTests {
		...
		public ParameterizedTests(final Class<?> classToMatch, final String methodToCheck,
				final TransactionType transactionType, final boolean shouldPassMatcherTest) {
		...
		public void insertTransactionPassesForRequiredAttribute() {
			boolean results = hasCorrectTransactionLevelOnMethod(this.methodToCheck, this.transactionType).matches(
					this.classToMatch);
