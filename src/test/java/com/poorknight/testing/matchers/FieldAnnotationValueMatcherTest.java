...
public class FieldAnnotationValueMatcherTest {
	...
	public void theSpecialFactoryMethodUsesTheCorrectParameters() throws Exception {
		...
		final Class<?> actualAnnotationClass = ReflectionUtils.getAttributeFromObject(identityMatcher, "annotationClass");
		final String actualAnnotationFieldName = ReflectionUtils.getAttributeFromObject(identityMatcher, "annotationFieldName");
		final GenerationType actualAnnotationFieldValue = ReflectionUtils.getAttributeFromObject(identityMatcher, "annotationFieldValue");
