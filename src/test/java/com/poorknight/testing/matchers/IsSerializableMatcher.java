...
/**
 * Responsible for checking whether an object is Serializable. It only checks the instance of the object that was
 * passed, so the test using this matcher must ensure that the object is representative of what will be found at
 * runtime. One concern is that if the object uses CDI, the test should be run inside of a CDI container.
 */
