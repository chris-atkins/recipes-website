...
public class SingleAuditFieldMatcher extends TypeSafeDiagnosingMatcher<Field> {
	...
	private SingleAuditFieldMatcher(final AuditFieldType fieldType) {
		...
		this.columnAnnotationMatcher = FieldAnnotationMatcher.hasAnnotationOnField(Column.class);
		this.temporalAnnotationMatcher = FieldAnnotationMatcher.hasAnnotationOnField(Temporal.class);
	...
	@Override
	public boolean matchesSafely(final Field fieldToMatch, final Description mismatchDescription) {
		...
		// LEAVING THIS HERE IN CASER THE DATE FIELD TYPE IS EVER CHANGED TO BE A DATE OR CALENDAR - THEN THIS CODE WOULD BE NECESSARY
