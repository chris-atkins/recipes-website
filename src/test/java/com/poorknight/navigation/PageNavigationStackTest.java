...
public class PageNavigationStackTest {
	...
	public static List<Object[]> params() {
		return Arrays.asList(new Object[][] {
				...
				{ "Two of the same locations pushed should result in only one entry.", new Location(PATH_1, QUERY_1), new Location(PATH_1, QUERY_1),
				...
				{ "Locations that don't start with /pages/ are ignored.", new Location(PATH_1, QUERY_1), new Location(NON_PAGES_PATH, QUERY_2), 1,
						new Location(PATH_1, QUERY_1) }, //
	...
	public PageNavigationStackTest(final String description, final Location first, final Location second, final int expectedNumberOfEntries,
